...
export const Page5 = () => {
  return (
    <PageWrapper>
      ...
      <p>
        Отец гордился бы им. Если бы был жив. У Егора никого не было. Отчасти именно поэтому
        он был идеальным кандидатом на роль «заглядывающего», как прозвали его в народе. А
        отчасти потому, что он был выдающимся человеком в плане здоровья. Ведь неизвестно чего
        ожидать по «ту сторону изгороди». Так что он был, можно сказать, Гагариным нового
        поколения.
      </p>
      <p>

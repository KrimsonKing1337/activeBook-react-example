...
export const Page38 = () => {
  ...
  return (
    <PageWrapper>
      ...
      <p>
        — Я часть той силы, что вечно хочет зла и вечно совершает благо, — прозвучал ответ.
      </p>
      <p>
      ...
      <p>
        ...
        покинуть границы своей, т.к. я её создал закольцованной. Но есть и грустные новости. Ты умер, Егор, — выдал
        Александр.
      </p>
      <p>
      ...
      <p>
        ...
        инверсии. Неприятно, но могло быть хуже, — заключил Александр.
      </p>
    </PageWrapper>
  );
};
